<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExtraPlanAmount.aspx.cs" Inherits="WebApp.ExtraPlanAmount" %>
...
<body>
    ...
    <div class="container">
        <h1>This is Your Extra PLan Amount</h1>
      
        <div class="login-container">
            <label for="planName">Plan Name:</label>
            <asp:TextBox ID="planN" runat="server" CssClass="input" />
